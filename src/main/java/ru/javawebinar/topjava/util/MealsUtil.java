...
public class MealsUtil {
    ...
    public static final List<Meal> meals = Arrays.asList(
            new Meal(1, LocalDateTime.of(2020, Month.JANUARY, 30, 10, 0), "Завтрак", 1600),
            ...
            new Meal(2, LocalDateTime.of(2020, Month.JANUARY, 30, 13, 0), "User2_Обед ", 1000),
            new Meal(2, LocalDateTime.of(2020, Month.JANUARY, 31, 0, 0), "User2_Еда", 2000),
            new Meal(2, LocalDateTime.of(2020, Month.JANUARY, 31, 13, 0), "User2_Обед", 500)
    );
